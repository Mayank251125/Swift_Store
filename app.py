...
def admin_login():
    ...
    if request.method == "POST":
        ...
        ALLOWED_ADMINS = [admin_env_email] if admin_env_email else ["swiftstore.noreply.official@gmail.com", "admin@swift.com"]
...
def pay(order_id):
    ...
    return render_template("payment.html", order=order, razorpay_key_id=RAZORPAY_KEY_ID)
